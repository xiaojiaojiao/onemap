<template>
  <page-container class="advance-form" title="高级表单">
    ...
    <repository-form-vue
      ref="repositoryForm"
      class="antd-pro-pages-form-advanced-form-style-card"
    />
    <task-form-vue ref="taskForm" class="antd-pro-pages-form-advanced-form-style-card" />
    <member-list />
...
import RepositoryFormVue from './repository-form.vue';
import TaskFormVue from './task-form.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    const repositoryForm = ref<InstanceType<typeof RepositoryFormVue>>(null);
    const taskForm = ref<InstanceType<typeof TaskFormVue>>(null);
